...
BOSS_LIST = [
    ...
    {"name": "創世神話獣オメガ", "hp": 650, "atk": 75, "def": 60, "spd": 45, "recovery": 20, "evasion": 25, "image": "images/omega.png"},
    {"name": "磁気嵐要塞マグネトロン", "hp": 700, "atk": 65, "def": 85, "spd": 20, "recovery": 5, "evasion": 5, "image": "images/magnetron.png"},
